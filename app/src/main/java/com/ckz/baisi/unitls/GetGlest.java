...
/**
 * Created by CKZ on 2017/1/21.
 */

public class GetGlest {
    ...
    public static int getGLESTextureLimitBelowLollipop() {
        int[] maxSize = new int[1];
        GLES10.glGetIntegerv(GLES10.GL_MAX_TEXTURE_SIZE, maxSize, 0);
        //Toast.makeText(mContext," " + maxSize[0],Toast.LENGTH_LONG).show();
        return maxSize[0];
    }
